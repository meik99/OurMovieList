...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "groups_friends" ADD CONSTRAINT "groups_friends_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."groups"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "groups_movies" ADD CONSTRAINT "groups_movies_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."groups"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "groups" ADD CONSTRAINT "groups_admin_id_users_id_fk" FOREIGN KEY ("admin_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "groups_friends_order_idx" ON "groups_friends" USING btree ("_order");
  CREATE INDEX "groups_friends_parent_id_idx" ON "groups_friends" USING btree ("_parent_id");
  CREATE INDEX "groups_movies_order_idx" ON "groups_movies" USING btree ("_order");
  CREATE INDEX "groups_movies_parent_id_idx" ON "groups_movies" USING btree ("_parent_id");
  CREATE INDEX "groups_admin_idx" ON "groups" USING btree ("admin_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "groups_friends" CASCADE;
  DROP TABLE "groups_movies" CASCADE;
